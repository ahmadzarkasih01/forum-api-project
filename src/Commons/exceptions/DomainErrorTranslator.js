...
DomainErrorTranslator._directories = {
  ...
  'THREAD_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('metode pada thread repository belum diimplementasikan'),
  ...
  // 🆕 Delete Comment
  'DELETE_COMMENT.NOT_CONTAIN_VALID_PAYLOAD': new InvariantError('tidak dapat menghapus comment karena properti yang dibutuhkan tidak ada'),
